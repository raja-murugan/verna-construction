(() => {
    ...
    var h = a.exports,
        c = "undefined" != typeof Element ? Element.prototype : {},
        f = c.matches || c.matchesSelector || c.webkitMatchesSelector || c.mozMatchesSelector || c.msMatchesSelector || c.oMatchesSelector,
        d = function (t, e) {
    ...
    var y = function () {
            function t(i, n) {
                e(this, t), this.x = v(i), this.y = v(n)
            }
            return n(t, null, [{
                key: "equals",
                value: function (t, e) {
        ...
        g = function () {
            function t(i, n, s, o, r) {
                e(this, t), this.id = r, this.left = i, this.top = n, this.width = s, this.height = o
            }
            return n(t, null, [{
                key: "intersects",
                value: function (t, e) {
        ...
        b = function () {
            function t(i, n) {
                e(this, t), E += 1, this.id = E, this.element = i, this.isRTL = n, this.isVisible = !0, this.isHidden = !1
            }
            return n(t, [{
                key: "show",
                value: function () {
                    this.isVisible = !0, this.element.classList.remove(_.HIDDEN), this.element.classList.add(_.VISIBLE), this.element.removeAttribute("aria-hidden")
                }
            }, {
                key: "hide",
                value: function () {
                    this.isVisible = !1, this.element.classList.remove(_.VISIBLE), this.element.classList.add(_.HIDDEN), this.element.setAttribute("aria-hidden", !0)
                }
            }, {
                key: "init",
                value: function () {
                    this.addClasses([_.SHUFFLE_ITEM, _.VISIBLE]), this.applyCss(t.Css.INITIAL), this.applyCss(this.isRTL ? t.Css.DIRECTION.rtl : t.Css.DIRECTION.ltr), this.scale = t.Scale.VISIBLE, this.point = new y
                }
            }, {
                key: "addClasses",
                value: function (t) {
                ...
                key: "dispose",
                value: function () {
                    this.removeClasses([_.HIDDEN, _.VISIBLE, _.SHUFFLE_ITEM]), this.element.removeAttribute("style"), this.element = null
                }
            }]), t
        }();
    b.Css = {
    ...
    var I = null,
        S = function () {
            ...
            return I = 10 === Math.round(v(i)), t.removeChild(e), I
        };

    function T(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null),
            n = v(i[e]);
        return S() || "width" !== e ? S() || "height" !== e || (n += v(i.paddingTop) + v(i.paddingBottom) + v(i.borderTopWidth) + v(i.borderBottomWidth)) : n += v(i.paddingLeft) + v(i.paddingRight) + v(i.borderLeftWidth) + v(i.borderRightWidth), n
    }
    var k = {
        reverse: !1,
        by: null,
    ...
    function O(t) {
        return !!L[t] && (L[t].element.removeEventListener(C, L[t].listener), L[t] = null, !0)
    }
    ...
    function z(t, e) {
        ...
        return t.addEventListener(C, n), L[i] = {
            element: t,
            listener: n
        }, i
    }
        ...
        return Object.keys(i).forEach((function (t) {
            ...
            if (h > 0) {
                ...
                (f = r.every((function (t) {
                    var e = new g(t.left + h, t.top, t.width, t.height, t.id),
                        i = !n.some((function (t) {
                            return g.intersects(e, t)
                        }));
                    return d.push(e), i
                }))) && (c = d)
            }
    ...
    var P = 0,
        j = function (t) {
            ...
            function s(t) {
                ...
                e(this, s), (n = i.call(this)).options = Object.assign({}, s.options, o), n.options.delimeter && (n.options.delimiter = n.options.delimeter), n.lastSort = {}, n.group = s.ALL_ITEMS, n.lastFilter = s.ALL_ITEMS, n.isEnabled = !0, n.isDestroyed = !1, n.isInitialized = !1, n._transitions = [], n.isTransitioning = !1, n._queue = [];
                var r = n._getElementOption(t);
                if (!r) throw new TypeError("Shuffle needs to be initialized with an element.");
                return n.element = r, n.id = "shuffle_" + P, P += 1, n._init(), n.isInitialized = !0, n
            }
            return n(s, [{
                key: "_init",
                value: function () {
                    if (this.items = this._getItems(), this.sortedItems = this.items, this.options.sizer = this._getElementOption(this.options.sizer), this.element.classList.add(s.Classes.BASE), this._initItems(this.items), this._onResize = this._getResizeFunction(), window.addEventListener("resize", this._onResize), "complete" !== document.readyState) {
                    ...
                    var e = window.getComputedStyle(this.element, null),
                        i = s.getSize(this.element).width;
                ...
                value: function (t, e) {
                    var i = this,
                        n = [],
                        o = [];
                    return t === s.ALL_ITEMS ? n = e : e.forEach((function (e) {
                ...
                value: function (t, e) {
                    ...
                    var i = e.getAttribute("data-" + s.FILTER_ATTRIBUTE_KEY),
                        n = this.options.delimiter ? i.split(this.options.delimiter) : JSON.parse(i);

                    function o(t) {
                        return n.includes(t)
                    }
                    return Array.isArray(t) ? this.options.filterMode === s.FilterMode.ANY ? t.some(o) : t.every(o) : n.includes(t)
                }
            }, {
                ...
                value: function (t) {
                    var e = this.options,
                        ...
                        o = Object.keys(b.Css.HIDDEN.before).map((function (t) {
                ...
                value: function (t, e) {
                    var i;
                    return 0 === (i = "function" == typeof this.options.columnWidth ? this.options.columnWidth(t) : this.options.sizer ? s.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : this.items.length > 0 ? s.getSize(this.items[0].element, !0).width : t) && (i = t), i + e
                }
            }, {
                key: "_getGutterSize",
                value: function (t) {
                ...
                key: "_setColumns",
                value: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : s.getSize(this.element).width,
                ...
                value: function (t) {
                    ...
                    t.forEach((function (t, s) {
                        ...
                        if (y.equals(t.point, i[s]) && !t.isHidden) return t.applyCss(b.Css.VISIBLE.before), void o();
                        t.point = i[s], t.scale = b.Scale.VISIBLE, t.isHidden = !1;
                ...
                value: function (t) {
                    ...
                    if (this.options.isCentered) {
                        var i = t.map((function (t, i) {
                            var n = s.getSize(t.element, !0),
                                o = e._getItemPosition(n);
                            return new g(o.x, o.y, n.width, n.height, i)
                        }));
                        return this.getTransformedPositions(i, this.containerWidth)
                    }
                    return t.map((function (t) {
                        return e._getItemPosition(s.getSize(t.element, !0))
                    }))
                }
            }, {
                ...
                value: function (t) {
                    return function (t) {
                        for (var e = t.itemSize, i = t.positions, n = t.gridSize, s = t.total, o = t.threshold, r = t.buffer, l = A(e.width, n, s, o), a = F(i, l, s), u = x(a, r), h = new y(n * u, a[u]), c = a[u] + e.height, f = 0; f < l; f++) i[u + f] = c;
                        return h
                    }({
                        itemSize: t,
                ...
                value: function () {
                    ...
                    e.forEach((function (e) {
                        ...
                        if (e.isHidden) return e.applyCss(b.Css.HIDDEN.before), void n();
                        e.scale = b.Scale.HIDDEN, e.isHidden = !0;
                        var s = t.getStylesForTransition(e, b.Css.HIDDEN.before);
                ...
                value: function () {
                    ...
                    e && t && this.isInitialized ? this._startTransitions(this._queue) : e ? (this._styleImmediately(this._queue), this._dispatch(s.EventType.LAYOUT)) : this._dispatch(s.EventType.LAYOUT), this._queue.length = 0
                }
            }, {
                ...
                value: function () {
                    this._transitions.length = 0, this.isTransitioning = !1, this._dispatch(s.EventType.LAYOUT)
                }
            }, {
                key: "filter",
                value: function (t, e) {
                    this.isEnabled && ((!t || t && 0 === t.length) && (t = s.ALL_ITEMS), this._filter(t), this._shrink(), this._updateItemCount(), this.sort(e))
                }
            }, {
                key: "sort",
                value: function () {
                    ...
                    if (this.isEnabled) {
                        this._resetCols();
                        var e = w(this._getFilteredItems(), t);
                ...
                value: function (t) {
                    ...
                    var n = w(this._mergeNewItems(i), this.lastSort),
                ...
                value: function (t) {
                    ...
                    if (t.length) {
                        ...
                        this._toggleFilterClasses({
                            ...
                            return !n.includes(t)
                        })), this._updateItemCount(), this.once(s.EventType.LAYOUT, (function () {
                            e._disposeItems(n), i.forEach((function (t) {
                                t.parentNode.removeChild(t)
                            })), e._dispatch(s.EventType.REMOVED, {
                                collection: i
                            })
                        }))
                    }
                ...
                value: function () {
                    var t = this;
                    this._disposeItems(this.items), this.isInitialized = !1, this.items = this._getItems(), this._initItems(this.items), this.once(s.EventType.LAYOUT, (function () {
    ...
    j.ShuffleItem = b, j.ALL_ITEMS = "all", j.FILTER_ATTRIBUTE_KEY = "groups", j.EventType = {
        ...
        isRTL: !1,
        roundTransforms: !0
    }, j.Point = y, j.Rect = g, j.__sorter = w, j.__getColumnSpan = A, j.__getAvailablePositions = F, j.__getShortColumn = x, j.__getCenteredPositions = R;
    const B = j;
    ...
    const W = function (e, i, n) {
        var s = document.querySelector(e);
        if (s) {
            var o = new B(s, function (e) {
    ...
    document.addEventListener("DOMContentLoaded", (function () {
        W(".gallery_masonry", ".gallery_filters-filter", {
