(() => {
    ...
    var r = function e(t, r) {
        ...
        if (t && r && "object" == typeof t && "object" == typeof r) {
            ...
            if ((i = (o = Object.keys(t)).length) !== Object.keys(r).length) return !1;
            for (s = i; 0 != s--;)
    ...
    class o {
        constructor({
            ...
            if (this.CALLBACK = "__googleMapsCallback", this.callbacks = [], this.done = !1, this.loading = !1, this.errors = [], this.apiKey = e, this.authReferrerPolicy = t, this.channel = s, this.client = l, this.id = n || i, this.language = a, this.libraries = c, this.mapIds = h, this.nonce = p, this.region = y, this.retries = u, this.url = g, this.version = d, o.instance) {
    ...
    document.addEventListener("DOMContentLoaded", (function () {
        ...
        e = "#map", r = new o({
            ...
            version: "weekly"
        }), i = document.querySelector(e), s = {
            lat: 40.74881584652125,
            lng: -73.98561648634562
        }, i && r.load().then((function () {
            var e = {
                    url: "./svg/pin.svg",
