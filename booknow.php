...
<head>
    ...
    <link rel=stylesheet href=css/single-project.min.css>
                        ...
                        <div class="about_info about_aside-item">
                            <div class=wrapper>
                                <div class=wrapper--helper>
                                    <h3 class="about_info-title title">About the Project</h3>
                                    <table class=about_info-table>
                                        <tbody>
                                            <tr class=about_info-table_row>
                                                <td class=property>Location</td>
                                                <td class=value>Prem Nager</td>
                                            </tr>
                                            <tr class=about_info-table_row>
                                                <td class=property>Near By</td>
                                                <td class=value>Panjapur Bus Stand</td>
                                            </tr>
                                            <tr class=about_info-table_row>
                                                <td class=property>Land Area</td>
                                                <td class=value>1250 Sq.Ft</td>
                                            </tr>
                                            <tr class=about_info-table_row>
                                                <td class=property>Construction Area</td>
                                                <td class=value>1400 Sq.ft</td>
                                            </tr>
                                            <tr class=about_info-table_row>
                                                <td class=property>Approval By</td>
                                                <td class=value>Trichy City Corporation</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div><a class="link link-arrow" href="tel:+917904678950">Call : +91 90430 10199</a>
                            </div>
                        </div>
                        <div class="about_contact about_aside-item primary-bg">
                            <div class=wrapper>
                                <h3 class="about_contact-title title">Contact For Booking</h3>
                                <ul class=contact-info>
                                    <li class=contact-info_group><span class=name>Address</span> <span class=content>No.
                                            3, B. P Complex, Opp. Velammal bodhi campus, Chinthamani nagar, Olaiyur main
                                            road, Udayanpatti, Trichy.</span></li>
                                    <li class=contact-info_group><span class=name>Email</span> <span
                                            class="content d-inline-flex flex-column"><a class=link
                                                href=mailto:info@vernaconstruction.com>info@vernaconstruction.com</a> <a
                                                class=link
                                                href=mailto:vernaconstruction@gmail.com>vernaconstruction@gmail.com</a></span>
                                    </li>
                                    <li class=contact-info_group><span class=name>Phone</span> <span
                                            class="content d-inline-flex flex-column"><a class=link
                                                href="tel:+919043010199">+91 90430 10199</a> <a class=link
                                                href="tel:+917904678950">+91 79046 78950</a></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
