        ...
        <div class=container>
            ...
            <div class=gallery_masonry data-role=gallery>
                ...
                <figure class=gallery_masonry-item data-groups='["Upcoming"]'><a class="aspect aspect--13x9"
                        ...
                        <div class=overlay>
                            <h4 class=overlay_caption>G+1, North Facing</h4><span class=overlay_label>Prem Nagar,
                ...
                <figure class=gallery_masonry-item data-groups='["Upcoming"]'><a class="aspect aspect--13x9"
                        ...
                        <div class=overlay>
                            <h4 class=overlay_caption>Ground Floor, South Facing</h4><span class=overlay_label>Prem
                ...
                <figure class=gallery_masonry-item data-groups='["Upcoming"]'><a class="aspect aspect--13x9"
                        ...
                        <div class=overlay>
                            <h4 class=overlay_caption>Ground Floor, North Facing</h4><span class=overlay_label>Prem
                                Nagar, Tiruchirapalli,Tamilnadu</span>
                        </div>
                    </a></figure>
                <figure class=gallery_masonry-item data-groups='["Upcoming"]'><a class="aspect aspect--13x9"
                ...
                <figure class=gallery_masonry-item data-groups='["Ongoing"]'><a class="aspect aspect--13x9"
                        ...
                        <div class=overlay>
                            <h4 class=overlay_caption>Pudukkottai</h4><span class=overlay_label>Sivapuram,
                                Pudukkottai</span>
                        </div>
                    </a></figure>
                <figure class=gallery_masonry-item data-groups='["Completed"]'><a class="aspect aspect--13x9"
                ...
                <figure class=gallery_masonry-item data-groups='["Completed"]'><a class="aspect aspect--13x9"
                        ...
                        <div class=overlay>
                            <h4 class=overlay_caption>Verna Engineers & Contractors</h4><span class=overlay_label>CKP
                                Garden, KK Nager, Tiruchirappalli</span>
                        </div>
                    </a></figure>
            </div>
        </div>
